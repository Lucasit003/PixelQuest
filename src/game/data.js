...
export const ABILITIES = {
  ...
  lightning: {
    ...
    desc: 'Reliable storm chain - no setup, no charge, three targets.',
  },
  arcane_shield: {
  ...
  backstab: {
    ...
    desc: 'A lunge that leaves the target open to a killing blow.',
  },
  poison_dagger: {
    ...
    desc: 'A thrown blade that keeps working after it lands.',
  },
  smoke_bomb: {
    ...
    speedMult: 1.5,
    invuln: 1.2,
    mana: 18, cd: 9, dmg: 6, kind: 'aoe', range: 44, freeze: 1.6, kb: 40,
    desc: 'Vanish in a choking cloud - untouchable for a moment, and gone.',
  },
  shadow_rush: {
  ...
  snare_trap: {
    ...
    scaling: 'attack',
    mana: 18, cd: 9, dmg: 14, kind: 'aoe', range: 58, freeze: 2.0, element: 'nature',
    desc: 'Roots everything around you - the answer to being surrounded.',
  },
  hunters_mark: {
    ...
    scaling: 'attack',
    range: 240,
    mana: 22, cd: 14, kind: 'mark', dur: 8,
    desc: 'Name a target. Precision shots punish it for eight seconds.',
  },
  // ---- Paladin ----
  holy_strike: {
    name: 'Holy Strike', cls: 'paladin', branch: 'Holy', icon: 'sword',
    gate: { cat: 'history', mastery: 0 }, // starter
    scaling: { attack: 0.5, magic: 0.5 },
    spendsGuard: 0.6,
    mana: 0, cd: 3, dmg: 30, kind: 'melee', range: 30, kb: 80, element: 'holy',
    desc: 'A radiant blow, heavier for every blow you turned aside.',
  },
  divine_shield: {
    ...
    scaling: { attack: 0.5, magic: 0.5 },
    banksGuard: true,
    mana: 16, cd: 13, kind: 'buff', dur: 8, shield: 90,
    desc: 'The Guard: what it absorbs is repaid as holy damage.',
  },
  consecration: {
  ...
  judgement: {
    ...
    scaling: { attack: 0.5, magic: 0.5 },
    mana: 24, cd: 6, dmg: 34, kind: 'chain', chains: 2, range: 200, element: 'holy',
  ...
  blood_frenzy: {
    ...
    scaling: 'attack',
    rageScaled: true,
    mana: 12, cd: 8, kind: 'buff', dur: 7, speedMult: 1.2,
    desc: 'The more you bleed, the harder you hit.',
  },
  whirling_axes: {
  ...
  execute: {
    ...
    desc: 'Finishes anything already close to the end.',
  },
  // ---- Summoner ----
  spirit_bolt: {
  ...
  wolf_totem: {
    ...
    gate: { cat: 'geo', mastery: 30 },
    scaling: 'magic',
    totem: { kind: 'wolf', life: 10, pulse: 1.6, radius: 54 },
    mana: 18, cd: 8, dmg: 18, kind: 'totem', range: 48, kb: 80,
    desc: 'Plant a totem; spirit wolves burst from it until it falls.',
  },
  chain_spirits: {
  ...
  sundering_blow: {
    ...
    scaling: 'attack',
    spendsMomentum: true,
    mana: 10, cd: 5, dmg: 26, kind: 'melee', range: 32, kb: 60, stun: 0.8,
    desc: 'Spends every point of Momentum in one shattering swing.',
  },
  iron_bulwark: {
    ...
    scaling: 'attack',
    holdsMomentum: true,
    mana: 20, cd: 15, kind: 'buff', dur: 9, shield: 70,
    desc: 'Set your feet: Momentum stops draining while it holds.',
  },
  earthshatter: {
    name: 'Earthshatter', cls: 'warrior', branch: 'Might', icon: 'axe',
    gate: { cat: 'math', mastery: 65 },
    scaling: 'attack',
    spendsMomentum: 'finisher',
  ...
  vanish: {
    ...
    scaling: 'attack',
    primesExposed: true,
    mana: 18, cd: 14, kind: 'buff', dur: 6, speedMult: 1.5,
    desc: 'Slip away, then open your next mark twice as wide.',
  },
  assassinate: {
  ...
  bear_trap: {
    ...
    desc: 'Set iron jaws on the ground ahead and wait.',
  },
  thornvine: {
  ...
  lay_on_hands: {
    ...
    scaling: { attack: 0.5, magic: 0.5 },
    heal: 70,
    mana: 10, cd: 10, kind: 'heal', dur: 0,
    desc: 'Close your wounds with a word.',
  },
  hammer_of_light: {
  ...
  sanctuary: {
    ...
    scaling: { attack: 0.5, magic: 0.5 },
    aura: { damageTaken: 0.65 },
    mana: 22, cd: 16, kind: 'aura', dur: 10, speedMult: 0.9,
    desc: 'Hallowed ground: everything that reaches you strikes softer.',
  },
  wrath_of_dawn: {
    ...
    desc: 'Everything you have endured, returned at once.',
  },
  ...
  bloodletting: {
    ...
    atkMult: 1.6,
    selfDamage: 0.12,
    mana: 12, cd: 12, kind: 'buff', dur: 8,
    desc: 'Open a vein for it: pay health, take the power.',
  },
  rampage: {
    ...
    desc: 'Charge forward through the crowd and send it flying.',
  },
  undying_wrath: {
  ...
  spirit_wisp: {
    ...
    desc: 'A drifting light that steers itself into a throat.',
  },
  stone_totem: {
    name: 'Stone Totem', cls: 'summoner', branch: 'Totems', icon: 'shield',
    gate: { cat: 'geo', mastery: 35 },
    scaling: 'magic',
    totem: { kind: 'stone', life: 12, radius: 60, damageTaken: 0.6 },
    mana: 15, cd: 12, kind: 'totem', dur: 9,
    desc: 'A stone guardian holds the ground around it.',
  },
  thorn_grove: {
  ...
  ancestral_chorus: {
    ...
    desc: 'Every totem you hold answers at once.',
  },
...
export const CLASSES = {
  ...
  ranger: {
    ...
    weapon: 'bow', ranged: true, shotRange: 240, combo: [14, 16, 22], reach: 30,
